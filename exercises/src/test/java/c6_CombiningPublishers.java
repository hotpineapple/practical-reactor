...
public class c6_CombiningPublishers extends CombiningPublishersBase {
    ...
    public void behold_flatmap() {
        ...
        currentUserEmail = currentUserMono.flatMap(u -> getUserEmail(u));
    ...
    public void task_executor() {
        ...
        tasks = taskExecutor().flatMap(f -> f);
    ...
    public void streaming_service() {
        ...
        messageFlux = streamingService().flatMapMany(m -> m);
    ...
    public void task_executor_again() {
        //todo: feel free to change code as you need
        Flux<Void> tasks = null;
        tasks = taskExecutor().concatMap(f->f);
    ...
    public void instant_search() {
        ...
        Flux<String> suggestions = userSearchInput()
                .switchMap(s -> autoComplete(s))//todo: use one operator only
                ;
    ...
    public void car_factory() {
        //todo: feel free to change code as you need
        Flux<Car> producedCars = Flux.zip(carChassisProducer(), carEngineProducer(), (c,e) -> new Car(c,e));
