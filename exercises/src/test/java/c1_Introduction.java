...
public class c1_Introduction extends IntroductionBase {
    ...
    /**
     * Retrieving result should last for a limited time amount of time, or you might get in trouble.maximum of 1 second or until a next signal is received.
     * Try retrieving result from service by blocking for
     */
    @Test
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
                .subscribe(companyList::add, e -> {}, () -> serviceCallCompleted.set(true)) //todo: change this line only
        ;
